...
function initFormHandler() {
  ...
  var recipes_string = JSON.parse(localStorage.getItem('recipes'));
  recipes_string[recipes_string.length]=recipeObject;
  localStorage.setItem("recipes",JSON.stringify(recipes_string));
  event.preventDefault();
})
  // B10. TODO - Get a reference to the "Clear Local Storage" button
  let clear_local=document.getElementsByClassName('danger')[0];
  // B11. TODO - Add a click event listener to clear local storage button
  clear_local.addEventListener('click',function(){
